...
BOOL NewRectangle( rectangle *rect, BOOL new )
{
	...
	DoMethod( BT_ok, MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
        ...
        DoMethod(WI_rect, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
	DoMethod(STR_label, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_rect, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_height);
	DoMethod(STR_height, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_rect, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_width);
	DoMethod(STR_width, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_rect, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_label);
