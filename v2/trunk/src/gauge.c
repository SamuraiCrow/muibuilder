...
BOOL NewGauge ( gauge *gauge_aux, BOOL new)
{
		...
		WindowContents, VGroup,
			...
			Child, VGroup,
				Child, ColGroup(4),GroupFrameT(GetMUIBuilderString(MSG_Choices)),
					...
					Child, HVSpace,
				End,
				Child, ColGroup(2),GroupFrameT(GetMUIBuilderString(MSG_Attributes)),
					...
					Child,STR_label = StringObject, StringFrame, MUIA_String_Contents, gauge_aux->label, End,
				End,
			End,
	...
	DoMethod(WI_gauge, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
	...
	DoMethod(STR_max, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_divide );
	DoMethod(STR_divide, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_height );
	DoMethod(STR_height, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime , WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_width);
	DoMethod(STR_width, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime , WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_InfoText );
	DoMethod(STR_InfoText, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime , WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_label );
	DoMethod(STR_label, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime , WI_gauge, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_max );


	if (!gauge_aux->fixheight) set( STR_height, MUIA_Disabled, TRUE );
