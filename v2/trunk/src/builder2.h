...
extern	int	nb_popasl, nb_popobject, nb_menu, nb_space, nb_scale, nb_barlabel;
...
extern BOOL SaveRequester( char*, char*, char* );
...
extern BOOL GetMUIarg( object*, APTR *, char *, queue *, BOOL, char* );
