...
#define Image(nr)		ImageObject, MUIA_Image_Spec, nr, MUIA_Image_FreeHoriz, TRUE, MUIA_Image_FreeVert, TRUE, MUIA_FixHeight, 10, MUIA_FixWidth, 15, MUIA_InputMode, MUIV_InputMode_RelVerify, End
...
APTR LoadImage( FILE *fichier, APTR father, int version )
{
	...
	if (version>104) ReadNotify( fichier, image_aux );
	if (version>=113) ReadArea(fichier, &image_aux->Area);
	image_aux->type = ReadInt(fichier);
	if (version<113) image_aux->Area.InputMode = ReadInt(fichier);
	...
	if (version<113) image_aux->Area.Frame = ReadInt(fichier)*MUIV_Frame_ImageButton;
	if (version>122) strcpy(image_aux->spec, LitChaine(fichier));
	return(image_aux);
}
...
BOOL NewImage( image *image_aux, BOOL new )
{
	...
	if (!(GR_GroupArea = CreateGR_AreaGroup(&image_aux->Area, TRUE, FALSE, TRUE, TRUE, FALSE)))
		return(FALSE);
	...
	WI_image = WindowObject,
		...
		WindowContents, VGroup,
			...
			Child, HGroup,
				Child, HVSpace,
				Child, ColGroup(5),GroupFrameT(GetMUIBuilderString(MSG_Images)),
				...
				End,
				Child, HVSpace,
				Child, ColGroup(2),GroupFrameT(GetMUIBuilderString(MSG_Choices)),
			...
			End,
			Child, ColGroup(2), GroupFrameT(GetMUIBuilderString(MSG_Size)),
				...
				Child, Label1(GetMUIBuilderString(MSG_Width)),
                               	Child, STR_width = StringObject,
                                       ...
                                       End,
			End,
			Child, ColGroup(2), GroupFrameT(GetMUIBuilderString(MSG_ImageIdent)),
				Child, Label2(GetMUIBuilderString(MSG_Label)),Child, STR_label = StringObject, StringFrame, MUIA_String_Contents, image_aux->label, MUIA_ExportID,1,End,
			End,
			End,
	...
	DoMethod( images[1], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 11);
	DoMethod( images[2], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 12);
	DoMethod( images[3], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 13);
	DoMethod( images[4], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 14);
	DoMethod( images[5], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 15);
	DoMethod( images[6], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 16);
	DoMethod( images[7], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 17);
	DoMethod( images[8], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 18);
	DoMethod( images[9], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 19);
	DoMethod( images[10], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 20);
	DoMethod( images[11], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 21);
	DoMethod( images[12], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 22);
	DoMethod( images[13], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 23);
	DoMethod( images[14], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 24);
	DoMethod( images[15], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 25);
	DoMethod( images[16], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 26);
	DoMethod( images[17], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 27);
	DoMethod( images[18], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 28);
	DoMethod( images[19], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 29);
	DoMethod( images[20], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 30);
	DoMethod( images[21], MUIM_Notify, MUIA_Pressed, FALSE, app, 2, MUIM_Application_ReturnID, 31);
        ...
        DoMethod( WI_image, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);

	DoMethod( CM_height, MUIM_Notify, MUIA_Selected, TRUE, STR_height, 3, MUIM_Set, MUIA_Disabled, FALSE);
	DoMethod( CM_height, MUIM_Notify, MUIA_Selected, FALSE, STR_height, 3, MUIM_Set, MUIA_Disabled, TRUE);

	DoMethod( CM_width, MUIM_Notify, MUIA_Selected, TRUE, STR_width, 3, MUIM_Set, MUIA_Disabled, FALSE);
	DoMethod( CM_width, MUIM_Notify, MUIA_Selected, FALSE, STR_width, 3, MUIM_Set, MUIA_Disabled, TRUE);

	DoMethod( STR_label, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_image, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_height);
	DoMethod( STR_height, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_image, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_width);
	DoMethod( STR_width, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_image, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_label );
	...
	DoMethod( WI_image, MUIM_Window_SetCycleChain, RegGroup,
		  ...
		  CM_vert, CM_horiz, CM_height, CM_width, PA_spec, STR_height, STR_width, STR_label,
		  ...
		  bt_ok, bt_cancel, NULL);
	if ( !image_aux->fixheight ) set( STR_height, MUIA_Disabled, TRUE );
	if ( !image_aux->fixwidth ) set( STR_width, MUIA_Disabled, TRUE );
	...
	DoMethod(app,OM_ADDMEMBER, WI_image);
		...
		case 31:
			...
			bool_aux = !bool_aux;
			if ((strlen(aux)==0)&&(image_aux->type == -1)) bool_aux = FALSE;
			...
			else ErrorMessage(GetMUIBuilderString(MSG_NeedImageLabel));
                        break;
                case ID_END:
			running = FALSE;
                        break;
