...
BOOL NewSlider( slider *slider_aux, BOOL new )
{
	...
	if (!(GR_GroupArea = CreateGR_AreaGroup(&slider_aux->Area, TRUE, TRUE, TRUE, TRUE, TRUE)))
		return(FALSE);
				...
				Child, VGroup,
					...
					Child, ColGroup(2),
						...
						Child, Label1(GetMUIBuilderString(MSG_Init)),
                		                ...
                		                End,
					End,
					Child, ColGroup(2), GroupFrameT(GetMUIBuilderString(MSG_SliderIdent)),
	...
	WI_current = WI_slider;
        ...
        DoMethod(WI_slider, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
	...
	DoMethod(STR_title, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_slider, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_label);
	DoMethod(STR_label, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_slider, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_title);
	DoMethod(STR_max, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_slider, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_min);
	DoMethod(STR_min, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_slider, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_init);
	DoMethod(STR_init, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime , WI_slider, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_max);

	DoMethod( WI_slider,MUIM_Window_SetCycleChain, RegGroup, CM_quiet, CM_title,
		  CM_reverse, CM_horizontal, STR_max, STR_min, STR_init, STR_title, STR_label,
