...
BOOL NewSpace( space *space_aux, BOOL new )
{
	...
	DoMethod(WI_space, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
	DoMethod(RA_type, MUIM_Notify, MUIA_Radio_Active, 0, STR_spacing, 3, MUIM_Set, MUIA_Disabled, FALSE );
	DoMethod(RA_type, MUIM_Notify, MUIA_Radio_Active, 1, STR_spacing, 3, MUIM_Set, MUIA_Disabled, FALSE );
	DoMethod(RA_type, MUIM_Notify, MUIA_Radio_Active, 2, STR_spacing, 3, MUIM_Set, MUIA_Disabled, TRUE );

	DoMethod( WI_space, MUIM_Window_SetCycleChain, RA_type, STR_spacing, STR_label,
