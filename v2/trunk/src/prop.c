...
BOOL NewProp ( prop *prop_aux, BOOL new)
{
		...
		WindowContents, VGroup,
			...
			Child, VGroup,
				...
				Child, ColGroup(2),GroupFrameT(GetMUIBuilderString(MSG_Attributes)),
					...
					Child,STR_label = StringObject, StringFrame, MUIA_String_Contents, prop_aux->label, End,
				End,
			End,
	...
	DoMethod(WI_prop, MUIM_Notify, MUIA_Window_CloseRequest, TRUE, app, 2, MUIM_Application_ReturnID, ID_OKWIN);
...
MUIM_Set, MUIA_Disabled, TRUE);
	...
	DoMethod(STR_entries,MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_prop, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_first );
	DoMethod(STR_first, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_prop, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_visible );
	DoMethod(STR_visible, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_prop, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_label );
	DoMethod(STR_label, MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, WI_prop, 3, MUIM_Set, MUIA_Window_ActiveObject, STR_entries);

	DoMethod( WI_prop, MUIM_Window_SetCycleChain, RegGroup, CM_horiz, CM_width,
		  CM_height, STR_width, STR_height, STR_entries, STR_first,
		  STR_visible, STR_label,
	...
	if ( !prop_aux->fixheight ) set( STR_height, MUIA_Disabled, TRUE );
	if ( !prop_aux->fixwidth ) set( STR_width, MUIA_Disabled, TRUE );
